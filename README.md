...
# <br><br>🟡 Обновлено — 03.08.2024 🟡
- **Исправлен баг, из-за которого скрипт не работал.<br><br>**
- **Обновление за 31.07.2024:**
- - ***Обновлены все запросы, скрипт полностью работоспособный;<br>***
- - ***Теперь выполняются абсолютно все задания.<br><br>***
...
- - ***Добавлено выполнение заданий.<br>***
