...
<summary><h1>🟡 Обновление за 11.08.2024</h1></summary>
  <ul>
    ...
    <li><strong>Обновлена механика защиты аккаунтов:</strong>
      <ul>
        <li><em>Никаких рандомных User-Agent'ов и прокси;</em></li>
        <li><em>Для каждого добавленного аккаунта создаётся своя уникальная личность;</em></li>
        <li><em>Личность генерируется раз и навсегда;</em></li>
        <li><em>У каждой личности уникальный User-Agent;</em></li>
        <li><em>У каждой личности рандомная модель телефона;</em></li>
        <li><em>У каждой личности рандомная версия Android;</em></li>
        <li><em>У каждой личности рандомная версия Google Chrome;</em></li>
        <li><em>У каждой личности рандомный клиент Telegram;</em></li>
        <li><em>У каждой личности автоматически устанавливается язык той страны, где расположен IP-адрес прокси.</em></li>
      </ul>
    </li>
    ...
    <li><strong>Проверка конфига, прокси и наличия обновления раз в день, с 20:00 до 21:30 по МСК;</strong></li>
    <li><strong>Для вашего удобства реализован механизм автообновления софта.</strong></li>
  </ul>
  <br>
